...
const pagesData$1 = {
  ...
  "v-8daa1a0e": () => import(
    ...
    "./assets/index.html-1176d84d.mjs"
  ).then(({ data }) => data),
  // path: /404.html
  "v-3706649a": () => import(
...
const siteData$1 = JSON.parse('{"base":"/","lang":"en-US","title":"ZoomTest","description":"Testing medium zoom with dynamic images","head":[],"locales":{}}');
const pagesComponents = {
  // path: /
  "v-8daa1a0e": defineAsyncComponent(() => import(
    /* webpackChunkName: "v-8daa1a0e" */
    "./assets/index.html-6175563a.mjs"
  )),
  // path: /404.html
  "v-3706649a": defineAsyncComponent(() => import(
    /* webpackChunkName: "v-3706649a" */
    "./assets/404.html-73a71ae2.mjs"
  ))
};
...
const _imports_0 = "/slide1.png";
const _imports_1 = "/slide2.png";
const _imports_2 = "/slide3.png";
const CarouSel2_vue_vue_type_style_index_0_scoped_0195489b_lang = "";
const CarouSel2_vue_vue_type_style_index_1_lang = "";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-0195489b><section class="pagination" data-v-0195489b><button class="btn"${ssrRenderAttr("onclick", _ctx.goBack)} data-v-0195489b>Back</button><button class="btn"${ssrRenderAttr("onclick", _ctx.goNext)} data-v-0195489b>Fwd</button></section><section class="paged-content" data-v-0195489b>`);
  if (_ctx.current == 1) {
    _push(`<div data-v-0195489b><div class="c-slide" data-v-0195489b><img class="c-image zoomable"${ssrRenderAttr("src", _imports_0)} alt="I1" data-v-0195489b></div><p class="c-text" data-v-0195489b>Text1</p></div>`);
  } else {
    _push(`<!---->`);
  }
  if (_ctx.current == 2) {
    _push(`<div data-v-0195489b><div class="c-slide" data-v-0195489b><img class="c-image zoomable"${ssrRenderAttr("src", _imports_1)} alt="I2" data-v-0195489b></div><p class="c-text" data-v-0195489b>Text2</p></div>`);
  } else {
    _push(`<!---->`);
  }
  if (_ctx.current == 3) {
    _push(`<div data-v-0195489b><div class="c-slide" data-v-0195489b><img class="c-image zoomable"${ssrRenderAttr("src", _imports_2)} alt="I3" data-v-0195489b></div><p class="c-text" data-v-0195489b>Text3</p></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</section></div>`);
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../components/CarouSel2.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const CarouSel2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-0195489b"], ["__file", "CarouSel2.vue"]]);
...
const pagesRoutes = [
  ["v-8daa1a0e", "/", { "title": "test" }, ["/index.html", "/Readme.md"]],
