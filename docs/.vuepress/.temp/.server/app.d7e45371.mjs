...
const pagesComponents = {
  ...
  "v-8daa1a0e": defineAsyncComponent(() => import(
    /* webpackChunkName: "v-8daa1a0e" */
    "./assets/index.html-a8384b57.mjs"
  )),
  // path: /404.html
  "v-3706649a": defineAsyncComponent(() => import(
    /* webpackChunkName: "v-3706649a" */
    "./assets/404.html-dba6e0c5.mjs"
  ))
};
...
const CarouSel2_vue_vue_type_style_index_0_scoped_8a88d8d1_lang = "";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(_attrs)} data-v-8a88d8d1><section class="pagination" data-v-8a88d8d1><button class="btn"${ssrRenderAttr("onclick", _ctx.goBack)} data-v-8a88d8d1>Back</button><button class="btn"${ssrRenderAttr("onclick", _ctx.goNext)} data-v-8a88d8d1>Fwd</button></section><section class="paged-content" data-v-8a88d8d1>`);
  if (_ctx.current == 1) {
    _push(`<div data-v-8a88d8d1><div class="c-slide" data-v-8a88d8d1><img class="c-image zoomable"${ssrRenderAttr("src", _imports_0)} alt="I1" data-v-8a88d8d1></div><p class="c-text" data-v-8a88d8d1>Text1</p></div>`);
  } else {
    _push(`<!---->`);
  }
  if (_ctx.current == 2) {
    _push(`<div data-v-8a88d8d1><div class="c-slide" data-v-8a88d8d1><img class="c-image zoomable"${ssrRenderAttr("src", _imports_1)} alt="I2" data-v-8a88d8d1></div><p class="c-text" data-v-8a88d8d1>Text2</p></div>`);
  } else {
    _push(`<!---->`);
  }
  if (_ctx.current == 3) {
    _push(`<div data-v-8a88d8d1><div class="c-slide" data-v-8a88d8d1><img class="c-image zoomable"${ssrRenderAttr("src", _imports_2)} alt="I3" data-v-8a88d8d1></div><p class="c-text" data-v-8a88d8d1>Text3</p></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</section></div>`);
...
const CarouSel2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-8a88d8d1"], ["__file", "CarouSel2.vue"]]);
